...
class TestPercentEncode(unittest.TestCase):
    def test_encode_Mark_13_21(self):
        link = "https://cdn.jsdelivr.net/gh/wldeh/bible-api/bibles/grc-byz1904/books/καταμαρκον/chapters/13/verses/21.json"
    ...
    def test_encode_Matt_24_23(self):
        link = "https://cdn.jsdelivr.net/gh/wldeh/bible-api/bibles/grc-byz1904/books/καταματθαιον/chapters/24/verses/23.json"
        encoded = percent_encode(link)
        self.assertEqual(
            encoded,
