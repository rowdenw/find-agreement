...
class Synopsis:
    def __init__(self, title, **kwargs):
        ...
        #TODO:self.summary = pd.DataFrame()
        self.table = Table()
        ...
        if kwargs.get("left_text") and kwargs.get("right_text"):
            ...
            left_data, right_data = self.match_lemmata(
                left_text, right_text
            )
            self.data[kwargs["left_passage"]] = [left_data]
            self.data[kwargs["right_passage"]] = [right_data]
    ...
    def match_lemmata(self, left_text, right_text):
    ...
    #TODO:def getSummary(self):
        #TODO:return self.summary
